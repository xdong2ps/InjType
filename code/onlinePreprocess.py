...
def makeData(srcFile, bioFile, featFiles, tgtFile, srcDicts, bioDicts, featDicts, tgtDicts, guideFile, guideDicts):
    src, guide, tgt = [], [], []
    bio = []
    feats = []
    switch, c_tgt = [], []
    ...
    while True:
        ...
        # src, tgt, bio, feat are all in lists
    ...
    return src, bio, feats, tgt, switch, c_tgt, guide


def prepare_data_online(train_src, src_vocab, train_bio, bio_vocab, train_feats, feat_vocab, train_tgt, tgt_vocab, train_guide_src, guide_src_vocab):
    dicts = {}
    ...
    train['tgt'], train['switch'], train['c_tgt'], train['guide_src'] = makeData(train_src, train_bio, train_feats, train_tgt,
                                                             dicts['src'], dicts['bio'], dicts['feat'], dicts['tgt'], train_guide_src, dicts['guide_src'])
